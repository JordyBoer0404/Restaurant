...
class TijdenController extends AbstractController
{
    ...
    {
        return $this->render('tijden/index.html.twig', [
            'tijdens' => $tijdenRepository->findAll(),
        ]);
    }
    ...
    {
        return $this->render('tijden/show.html.twig', [
            'tijden' => $tijden,
        ]);
    }
